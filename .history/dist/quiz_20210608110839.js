...
function showResults() {
    ...
    myQuestions.forEach((currentQuestion, questionNumber) => {
        ...
        if(pyth > socr && pyth > ari) {
            ...
            results.innerHTML = `<div class='results'>You follow Socrates. He is one of the ugliest man you have ever seen, but something about his personality draws you in to listen to his words. He teaches nothing, but he tells everyone that he believes knowledge is virtue. He has taught you to question every idea that you once thought were true</div>`;
