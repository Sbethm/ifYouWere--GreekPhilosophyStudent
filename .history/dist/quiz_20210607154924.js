...
function showResults() {
    ...
    myQuestions.forEach((currentQuestion, questionNumber) => {
        ...
        if(userAnswer === currentQuestion.answers.p){
            ...
            socr++;
        }else if(userAnswer === currentQuestion.answers.a){
            ari++;
        }
    });
    //show results
    if(path > socr && path > ari) {
        results.innerHTML = `<div class='results--pyth'>Path Wins!</div>`;
    } else if(socr > path && socr > ari) {
        results.innerHTML = `<div class='results--socr'>Socr Wins!</div>`;
    } else if(ari > path && ari > socr) {
        results.innerHTML = `<div class='results--ari'>Ari Wins!</div>`;
    } else {
        results.innerHTML = `<div class='results--you'>You don't really can't really adhere to any of these Greek Philosophers. . .perhaps this is because you were meant to start your own branch of ancient greek philosophy! Now, go build that time machine and get back there to teach them your philosophical ways!</div>`
    }
...
const myQuestions = [
    ...
    },
    {
        ...
        answers: {
            p: "He believed that everything was made of numbers and that the number three was a symbol of the god, Apollo.",
