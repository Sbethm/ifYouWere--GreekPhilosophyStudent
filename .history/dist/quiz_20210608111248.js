...
function showResults() {
    ...
    myQuestions.forEach((currentQuestion, questionNumber) => {
        ...
        if(pyth > socr && pyth > ari) {
            ...
            results.innerHTML = `<div class='results'>You follow Aristotle. He was a student of Plato and learned from him about Socrates' logical questioning. He questioned and stu</div>`;
        } else {
