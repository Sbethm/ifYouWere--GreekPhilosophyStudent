...
function showResults() {
    ...
    myQuestions.forEach((currentQuestion, questionNumber) => {
        ...
        if(path > socr && path > ari) {
            ...
            results.innerHTML = `<div class='results'>You can't seem decide which philosopher to follow. Perhaps you should start your own school of philosophy! So, go ahead</div>`;
        }
