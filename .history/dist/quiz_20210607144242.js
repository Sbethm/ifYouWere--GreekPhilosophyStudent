...
function showResults() {
    ...
    myQuestions.forEach((currentQuestion, questionNumber) => {
        ...
        if(path > socr && path > ari) {
            ...
            results.innerHTML = `<div class='results--you'>You don't really can't really adhere to any of these Greek Philosophers. . .perhaps this is because you were meant to start your own branch of ancient greek philosophy! Now, go build that time machine and get back there to teach them your `
        }
