...
function showResults() {
    ...
    myQuestions.forEach((currentQuestion, questionNumber) => {
        ...
        if(pyth > socr && pyth > ari) {
            results.innerHTML = `<div class='results'>You follow Pythagoras.  When he invited you into his closed community, you vowed that you would never speak about what you learned or did there. Together, with your brethren you practice music, wrestling, and the mystic art of numbers. Pythagoras believed that when the body died, the soul moved on to another body and claimed that he was once the son of the god Hermes. Who were you in your past lives? Maybe you were Pythagoras himself!</div>`;
        } else if(socr > pyth && socr > ari) {
            results.innerHTML = `<div class='results'>You follow Socrates. He is one of the ugliest man you have ever seen, but something about his personality draws you in to listen to his words. He teaches nothing, but he tells everyone that he believes knowledge is virtue. He has taught you to question every idea that you once thought were true, from the gods to the law to why the sun rises and sets.</div>`;
        } else if(ari > pyth && ari > socr) {
            results.innerHTML = `<div class='results'>You follow Aristotle. He was a student of Plato and learned from him about Socrates' logical questioning. Not only did he question, he also searched for the answers. He used the first forms of the scientific method to study the world. He also was the tutor of Alexander the Great who, while out on war campaigns, gathered animal and plant speciemens for his beloved teacher to study. With the knowledge he gathered, Aristotle created a library full of knowledge.</div>`;
        } else {
