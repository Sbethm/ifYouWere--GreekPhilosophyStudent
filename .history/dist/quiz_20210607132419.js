...
const myQuestions = [
    ...
    {
        question: "Your teacher founded a school with practices and traditions that you respect and are willing to follow in hopes of attaining further knowledge. What is founding principal of your school?",
        answers: {
            p: "a life of abstinence from sexual pleasure and physical extravagance along with frequent fasting and vegetarianism",
            s: "He never founded a school and, in fact, claimed to know and teach nothing",
    ...
    },
    {
        ...
        answers: {
            p: "He believed in the gods but not that they were the reasons for events that happened in the world",
            s: "He never claimed to believe or not but he would vigorously question those that did and the logic behind their beliefs",
            a: "sepuku"
        }
    }, 
    {
