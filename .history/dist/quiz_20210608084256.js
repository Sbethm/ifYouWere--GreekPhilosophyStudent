...
//These varibales need to occur after the function showSlide() so that the classList '.active-slide' is assigned first
const beginAgain = document.getElementById('restart');
