...
function showResults() {
    ...
    myQuestions.forEach((currentQuestion, questionNumber) => {
        ...
        if(pyth > socr && pyth > ari) {
            results.innerHTML = `<div class='results'>You follow Pythagoras. When he invited you into his closed community, you vowed that you would never speak about </div>`;
