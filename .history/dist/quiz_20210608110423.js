...
function showResults() {
    ...
    myQuestions.forEach((currentQuestion, questionNumber) => {
        ...
        if(pyth > socr && pyth > ari) {
            results.innerHTML = `<div class='results'>You follow Pythagoras. PythWhen he invited you into his closed community, you vowed that you would never speak about what you learned or did there. Together, with your brethern you practice music, wrestling, and the mystic art of numbers.</div>`;
